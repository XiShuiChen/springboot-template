...
import {Key, User, Message, ChatDotSquare} from "@element-plus/icons-vue";
  ...
  formRef.value.validate((valid) => {
    if (valid) {
      post('api/auth/register', {...form}, () => {
        ElMessage.success('注册成功，欢迎来到我的网站')
        router.push('/')
      })
    } else {
...
<template>
  <div style="text-align: center; margin: 0 20px">
    <div style="margin-top: 100px">
      ...
      <div style="font-size: 14px; margin-top: 10px; color: rgb(128,128,128)">
        欢迎来到我的网站，请在下方填写相关信息注册
      </div>
    </div>
    ...
    <div>
      <span style="font-size: 14px; line-height: 15px; color: rgb(128,128,128)">已有账号？</span>
